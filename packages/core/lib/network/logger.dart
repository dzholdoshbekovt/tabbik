...
class PrettyDioLogger extends Interceptor {
  ...
  void onError(DioException err, ErrorInterceptorHandler handler) {
    if (error) {
      if (err.type == DioExceptionType.badResponse) {
        ...
        _printBoxed(
            header:
                '\x1B[31mDioError\x1B[0m ║ Status: ${err.response?.statusCode} ${err.response?.statusMessage}',
            text: uri.toString());
        ...
        _printBoxed(
            header: '\x1B[31mDioError\x1B[0m ║ ${err.type}', text: err.message);
      }
    }
  ...
  void _printRequestHeader(RequestOptions options) {
    ...
    _printBoxed(
        header: '\x1B[33mRequest\x1B[0m  ║ $method ', text: uri.toString());
  }
